									   ...
									   <tbody>
										...
										<?php foreach($category_details AS $detail) {?>
										  <tr class="gradeA odd" role="row">
											 ...
											 <td class="center">
												<a href="<?php echo base_url('category-edit/'.$detail->code);?>" class="btn btn-success" title="Edit">Edit</a>&nbsp;
												<a href="<?php echo base_url('category/category_delete/'.$detail->code);?>" class="btn btn-danger" title="Delete">Delete<a>												
											</td>
										  </tr>
										  <?php } ?>
										  <?php }else{ ?>
