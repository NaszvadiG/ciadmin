						...
						<div class="panel-body">
							<div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
							  <div class="row">
								 ...
								 <div class="col-sm-6">
									<form action="<?php echo base_url('user-list');?>" method="GET" role="form">
									   ...
									   <tbody>
										...
										?>
										  <tr class="gradeA odd" role="row">
											 ...
											 <td class="center">
												<a href="<?php echo base_url('user-edit/'.$detail->username);?>" class="btn btn-success" title="Edit">Edit</a>&nbsp;
												<a href="<?php echo base_url('user/user_delete/'.$detail->username);?>" class="btn btn-danger" title="Delete">Delete<a>
											</td>
										  </tr>
										  <?php } 
											}else{
