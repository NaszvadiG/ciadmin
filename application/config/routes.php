...
$route['product-edit/(:num)'] = 'product/product_add/$1';

$route['order-list'] = 'order/order_list';
$route['order-add'] = 'order/order_add';
$route['order-edit/(:num)'] = 'order/order_add/$1';

$route['coupon-list'] = 'coupon/coupon_list';
$route['coupon-add'] = 'coupon/coupon_add';
$route['coupon-edit/(:num)'] = 'coupon/coupon_add/$1';
